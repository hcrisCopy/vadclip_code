"""Concat-feature datasets used by the direct score residual adapter."""
...
class ScoreResidualTrainDataset(Dataset):
    """Load global-768 concat features with the ordinary VadCLIP reduction."""
