"""Repository-local imports and checkpoint helpers for the score adapter."""
...
def add_injection_source() -> None:
    """Expose shared VadCLIP experiment utilities without cross-project imports."""
...
def state_dict_from_file(path: str) -> dict:
    """Load a raw state dict or the model state within a resumable checkpoint."""
    import torch
...
def initialize_from_baseline(model, baseline_path: str) -> int:
    """Copy the official frozen VadCLIP tensors into a new wrapper."""
