# VadCLIP 神经元残差注入：稳定性 global-768（UCF / XD-Violence）
...
方法保持如下边界：VadCLIP 的冻结 `logits1` 给异常训练视频生成伪分数；每个视频内部的 top/bottom `p` 片段形成配对 ShiftScore；对异常视频做 20 次 80% 的稳定性抽样，在全部 CLIP ViT-B/16 CLS 神经元中按 ShiftScore × global-top-768 入选频率全局取 768 个，得到 768D z-score 特征；其与同时间步的 512D 最终 CLIP 特征拼成 1280D。训练时只学习一个带小门控的 `768 -> 1024 -> 1024 -> 512` 残差分支，原始 512D VadCLIP 始终冻结。
...
python experiments/vadclip_neuron_injection/select_neurons_intravideo_paired.py \
  ...
  --out-dir ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/neurons \
  --top-p 0.10 \
  --topk-global 768 \
  --bootstrap-repeats 20 \
  --bootstrap-fraction 0.80 \
  --bootstrap-seed 234 \
  --normal-stat-snippets-per-video 256 \
  --sigma-min 1e-6

python experiments/vadclip_neuron_injection/make_concat_neuron_json.py \
  --source-neuron-json ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/neurons/selected_neurons.json \
  --out-dir ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/concat_neurons \
  --neuron-width 768 \
  --clip-dim 512
...
python experiments/vadclip_neuron_injection/build_concat_features.py \
  ...
  --hidden-manifest ../vad_data/work_ucf/clip_hidden_stride16_train_8gpu/manifest.csv \
  --neuron-json ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/concat_neurons/selected_neurons.json \
  --out-dir ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/features/train \
  --out-csv ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/ucf_concat_train.csv
...
python experiments/vadclip_neuron_injection/build_concat_features.py \
  ...
  --neuron-json ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/concat_neurons/selected_neurons.json \
  --out-dir ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/features/test \
  --out-csv ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/ucf_concat_test.csv

python experiments/vadclip_neuron_injection/train_single_vadclip_style.py \
  --dataset ucf \
  --train-list ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/ucf_concat_train.csv \
  --test-list ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/ucf_concat_test.csv \
  --neuron-json ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/concat_neurons/selected_neurons.json \
  --init-baseline-model ../vadclip_data/model/vadclip_ucf.pth \
  --checkpoint-path ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/training/checkpoint_last.pth \
  --model-path ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/training/model_best.pth \
  --out-dir ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/training \
  --vadclip-root VadCLIP \
  --max-epoch 10 \
  --batch-size 64 \
  --lr 2e-5 \
...
python experiments/vadclip_neuron_injection/test_single_vadclip_style.py \
  ...
  --neuron-json ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/concat_neurons/selected_neurons.json \
  --model-path ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/training/model_best.pth \
  --out-dir ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/evaluation \
  --vadclip-root VadCLIP \
  --num-workers 0 \
  --residual-hidden-dim 1024 \
  --residual-depth 3 \
...
```text
../vadclip_data/work_ucf_residual/compare_bottom10/global_top768_stable_b20_f080/
  neurons/selected_neurons.json              # 配对 ShiftScore、normal mean/std、稳定性全局 top-768
  neurons/stability_frequency.npy              # 20 次视频级抽样的 global-top-768 入选频率
  neurons/selection_scores.npy                 # ShiftScore × 入选频率的最终排序分数
...
稳定性选择只重跑神经元选择阶段，且复用已有 pseudo score 与 hidden；原始 global-768（非稳定性）结果保留在相邻 `global_top768/` 目录。训练意外中断后，在原训练命令末尾加 `--resume`；它会恢复模型、optimizer、scheduler、epoch 和最佳指标。伪分数、拼接特征和测试会默认跳过已完成且契约正确的单项文件。数据变更或要完全重算时，对对应命令加 `--clean`，不要对其他阶段盲目清理。
...
python experiments/vadclip_neuron_injection/select_neurons_intravideo_paired.py \
  ...
  --out-dir ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/neurons \
  --top-p 0.10 \
  --topk-global 768 \
  --bootstrap-repeats 20 \
  --bootstrap-fraction 0.80 \
...
python experiments/vadclip_neuron_injection/make_concat_neuron_json.py \
  --source-neuron-json ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/neurons/selected_neurons.json \
  --out-dir ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/concat_neurons \
  --neuron-width 768 \
  --clip-dim 512
...
python experiments/vadclip_neuron_injection/build_concat_features.py \
  ...
  --hidden-manifest ../vad_data/work_xd/clip_hidden_stride16_train_8gpu/manifest.csv \
  --neuron-json ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/concat_neurons/selected_neurons.json \
  --out-dir ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/features/train \
  --out-csv ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/xd_concat_train.csv \
  --keep-missing
...
python experiments/vadclip_neuron_injection/build_concat_features.py \
  ...
  --neuron-json ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/concat_neurons/selected_neurons.json \
  --out-dir ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/features/test \
  --out-csv ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/xd_concat_test.csv \
...
python experiments/vadclip_neuron_injection/train_single_vadclip_style_xd.py \
  --dataset xd \
  --train-list ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/xd_concat_train.csv \
  --test-list ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/xd_concat_test.csv \
  --neuron-json ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/concat_neurons/selected_neurons.json \
  --init-baseline-model ../vadclip_data/model/vadclip_xd.pth \
  --checkpoint-path ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/training/checkpoint_last.pth \
  --model-path ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/training/model_best.pth \
  --out-dir ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/training \
  --vadclip-root VadCLIP \
  --max-epoch 10 \
  --batch-size 96 \
  --lr 1e-5 \
...
python experiments/vadclip_neuron_injection/test_single_vadclip_style_xd.py \
  ...
  --neuron-json ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/concat_neurons/selected_neurons.json \
  --model-path ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/training/model_best.pth \
  --out-dir ../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/evaluation \
  --vadclip-root VadCLIP \
  --num-workers 0 \
  --residual-hidden-dim 1024 \
  --residual-depth 3 \
...
```text
../vadclip_data/work_xd_residual/compare_bottom10/global_top768_stable_b20_f080/
