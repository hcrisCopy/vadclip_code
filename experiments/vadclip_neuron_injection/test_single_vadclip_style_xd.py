#!/usr/bin/env python3
"""Standalone, resumable XD-Violence test for VadCLIP residual injection."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate a VadCLIP gated neuron residual model on XD-Violence.")
    ...
    for item in tqdm(loader, desc="VadCLIP XD residual test", unit="video"):
