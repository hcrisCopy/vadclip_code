...
方法保持如下边界：VadCLIP 的冻结 `logits1` 给异常训练视频生成伪分数；每个视频内部的 top/bottom `p` 片段形成配对 ShiftScore；在全部 CLIP ViT-B/16 CLS 神经元中全局取 ShiftScore 最高的 768 个，得到 768D z-score 特征；其与同时间步的 512D 最终 CLIP 特征拼成 1280D。训练时只学习一个带小门控的 `768 -> 1024 -> 1024 -> 512` 残差分支，原始 512D VadCLIP 始终冻结。
...
python experiments/vadclip_neuron_injection/select_neurons_intravideo_paired.py \
  ...
  --out-dir ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768/neurons \
  --top-p 0.10 \
  --topk-global 768 \
...
python experiments/vadclip_neuron_injection/make_concat_neuron_json.py \
  --source-neuron-json ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768/neurons/selected_neurons.json \
  --out-dir ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768/concat_neurons \
  --neuron-width 768 \
  --clip-dim 512
...
python experiments/vadclip_neuron_injection/build_concat_features.py \
  ...
  --out-dir ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768/features/train \
  --out-csv ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768/ucf_concat_train.csv
...
python experiments/vadclip_neuron_injection/build_concat_features.py \
  ...
  --neuron-json ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768/concat_neurons/selected_neurons.json \
  --out-dir ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768/features/test \
  --out-csv ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768/ucf_concat_test.csv
...
python experiments/vadclip_neuron_injection/train_single_vadclip_style.py \
  ...
  --checkpoint-path ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768/training/checkpoint_last.pth \
  --model-path ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768/training/model_best.pth \
  --out-dir ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768/training \
  --vadclip-root VadCLIP \
  --max-epoch 10 \
  --batch-size 64 \
  --lr 2e-5 \
...
python experiments/vadclip_neuron_injection/test_single_vadclip_style.py \
  ...
  --neuron-json ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768/concat_neurons/selected_neurons.json \
  --model-path ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768/training/model_best.pth \
  --out-dir ../vadclip_data/work_ucf_residual/compare_bottom10/global_top768/evaluation \
  --vadclip-root VadCLIP \
  --num-workers 0 \
  --residual-hidden-dim 1024 \
  --residual-depth 3 \
...
```text
../vadclip_data/work_ucf_residual/compare_bottom10/global_top768/
  neurons/selected_neurons.json              # 配对 ShiftScore、normal mean/std、全局 top-768
...
python experiments/vadclip_neuron_injection/select_neurons_intravideo_paired.py \
  ...
  --out-dir ../vadclip_data/work_xd_residual/compare_bottom10/global_top768/neurons \
  --top-p 0.10 \
  --topk-global 768 \
  --normal-stat-snippets-per-video 256 \
  --sigma-min 1e-6
...
python experiments/vadclip_neuron_injection/make_concat_neuron_json.py \
  --source-neuron-json ../vadclip_data/work_xd_residual/compare_bottom10/global_top768/neurons/selected_neurons.json \
  --out-dir ../vadclip_data/work_xd_residual/compare_bottom10/global_top768/concat_neurons \
  --neuron-width 768 \
  --clip-dim 512
...
python experiments/vadclip_neuron_injection/build_concat_features.py \
  ...
  --out-dir ../vadclip_data/work_xd_residual/compare_bottom10/global_top768/features/train \
  --out-csv ../vadclip_data/work_xd_residual/compare_bottom10/global_top768/xd_concat_train.csv \
  --keep-missing
...
python experiments/vadclip_neuron_injection/build_concat_features.py \
  ...
  --neuron-json ../vadclip_data/work_xd_residual/compare_bottom10/global_top768/concat_neurons/selected_neurons.json \
  --out-dir ../vadclip_data/work_xd_residual/compare_bottom10/global_top768/features/test \
  --out-csv ../vadclip_data/work_xd_residual/compare_bottom10/global_top768/xd_concat_test.csv \
...
python experiments/vadclip_neuron_injection/train_single_vadclip_style_xd.py \
  ...
  --checkpoint-path ../vadclip_data/work_xd_residual/compare_bottom10/global_top768/training/checkpoint_last.pth \
  --model-path ../vadclip_data/work_xd_residual/compare_bottom10/global_top768/training/model_best.pth \
  --out-dir ../vadclip_data/work_xd_residual/compare_bottom10/global_top768/training \
  --vadclip-root VadCLIP \
  --max-epoch 10 \
  --batch-size 96 \
  --lr 1e-5 \
...
python experiments/vadclip_neuron_injection/test_single_vadclip_style_xd.py \
  ...
  --neuron-json ../vadclip_data/work_xd_residual/compare_bottom10/global_top768/concat_neurons/selected_neurons.json \
  --model-path ../vadclip_data/work_xd_residual/compare_bottom10/global_top768/training/model_best.pth \
  --out-dir ../vadclip_data/work_xd_residual/compare_bottom10/global_top768/evaluation \
  --vadclip-root VadCLIP \
  --num-workers 0 \
  --residual-hidden-dim 1024 \
  --residual-depth 3 \
...
```text
../vadclip_data/work_xd_residual/compare_bottom10/global_top768/
