"""Local import and checkpoint helpers for the supervised diagnostic."""
...
def state_dict_from_file(path: str) -> dict:
    """Load either a raw model state dictionary or a resumable checkpoint."""
    import torch
...
def initialize_from_baseline(model, baseline_path: str) -> int:
    """Copy the unchanged official VadCLIP tensors into the wrapper."""
